...
const Historia = () => {
    ...
    return (
        <>
            <h1 style={style}>HISTORIA</h1>
            <p>En la noche de la firma de un tratado de paz entre los reinos de Lucis y Niflheim, en la que la
                familia real
            ...
            <p>La Fuerzas Niflheim arrasan la ciudad de la corona, al parecer matando al rey Regis Caelum. El
                Hijo del rey
            ...
            <p>El informe de que Noctis ha muerto es toda una farsa. Cuando el príncipe se da cuenta que Idola
                Aldercapt y
